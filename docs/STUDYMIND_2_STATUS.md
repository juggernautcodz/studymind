...
- Ordinary production build/startup, module import, and route-registration paths do not mutate schema or durable database data. They contain no `prisma db push` command, and Prisma generation plus the server bundle build do not apply migrations.
